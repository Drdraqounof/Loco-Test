...
For a current implementation-focused breakdown of application orchestration, database design, model usage, and infrastructure, see `Documentation/SYSTEM_ARCHITECTURE.md`.
